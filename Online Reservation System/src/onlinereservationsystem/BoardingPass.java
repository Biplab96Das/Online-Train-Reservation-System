...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        JLabel heading = new JLabel("IRCTC");
        heading.setBounds(380, 10, 450, 35);
        heading.setFont(new Font("Tahoma", Font.PLAIN, 32));
        add(heading);
        
        JLabel subheading = new JLabel("Online Ticket");
        ...
        JLabel lblfcode = new JLabel("Train Code");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("onlinereservationsystem/icons/details.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                labelfname.setText(rs.getString("trainname"));  
                labelfcode.setText(rs.getString("traincode"));  
